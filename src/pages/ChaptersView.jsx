...
const ChaptersView = () => {
  ...
  if (!radar || !subject) {
    return (
      <div className="min-h-screen bg-[rgb(25,25,25)] flex items-center justify-center">
    ...
    <div className="min-h-screen bg-[rgb(25,25,25)]">
      ...
      <header className="bg-[rgb(32,32,32)] border-b border-[rgb(47,47,47)] px-6 py-4 sticky top-0 z-50">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-2xl font-bold text-white/81 mb-2">{subject.name}</h1>
            <div className="flex items-center justify-center gap-3">
              <div className="w-[200px] h-1 bg-white/[0.055] rounded-sm overflow-hidden">
                <div
                  className="h-full bg-[rgb(35,131,226)] rounded-sm transition-all duration-300"
                  style={{ width: `${progress}%` }}
                />
              </div>
              <span className="text-sm text-white/46">Progression: {progress}%</span>
            </div>
          </div>
      ...
      <div className="px-6 py-4 max-w-[1000px] mx-auto">
        <div className="relative">
          <svg
            className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-white/46"
            viewBox="0 0 16 16"
            fill="currentColor"
          >
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-white/[0.055] border border-white/[0.094] rounded-md text-white/81 placeholder-white/46 focus:outline-none focus:border-white/20 focus:bg-white/[0.08] transition-all duration-150"
          />
        </div>
      </div>
