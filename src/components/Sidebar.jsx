...
const Sidebar = () => {
  ...
  return (
    <aside className={`${isCollapsed ? 'w-[50px]' : 'w-[260px]'} h-screen bg-white/70 backdrop-blur-sm ring-1 ring-gray-200 flex flex-col transition-all duration-200 shadow-[12px_0_32px_rgba(0,0,0,0.06)]`}>
      {/* Header */}
