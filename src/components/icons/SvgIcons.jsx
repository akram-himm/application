...
// Icônes SVG centralisées pour remplacer les emojis
export const Icons = {
  ...
  layout: (
    <svg fill="currentColor" viewBox="0 0 24 24">
      <path d="M18,5V18H15V5M3,13V18H9V13M3,5V11H9V5M11,5V11H21V5M11,18H21V13H11V18Z"/>
    </svg>
  ),
  component: (
    <svg fill="currentColor" viewBox="0 0 24 24">
      <path d="M16,9H21.5L16,3.5V9M7,2H17L23,8V18A2,2 0 0,1 21,20H7C5.89,20 5,19.1 5,18V4A2,2 0 0,1 7,2M3,6V22H19V24H3A2,2 0 0,1 1,22V6H3Z"/>
    </svg>
  ),
  table: (
    <svg fill="currentColor" viewBox="0 0 24 24">
...
// Fonction helper pour obtenir une icône avec des props personnalisées
export const getIcon = (name, className = "w-5 h-5", props = {}) => {
  const icon = Icons[name] || Icons.document;
  return React.cloneElement(icon, { className, ...props });
};
